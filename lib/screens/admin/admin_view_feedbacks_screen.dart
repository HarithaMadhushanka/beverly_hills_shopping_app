...
class AdminViewFeedbacksScreen extends StatefulWidget {
  const AdminViewFeedbacksScreen({Key key, this.outletID}) : super(key: key);
  final String outletID;

  @override
  _AdminViewFeedbacksScreenState createState() =>
      _AdminViewFeedbacksScreenState();
}

class _AdminViewFeedbacksScreenState extends State<AdminViewFeedbacksScreen> {
