...
import 'package:beverly_hills_shopping_app/screens/admin/admin_view_feedbacks_screen.dart';
import 'package:beverly_hills_shopping_app/utils/enums.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class AdminOutletDetailsScreen extends StatefulWidget {
  const AdminOutletDetailsScreen({Key key, this.outlet}) : super(key: key);
  final DocumentSnapshot<Object> outlet;

  @override
  _AdminOutletDetailsScreenState createState() =>
      _AdminOutletDetailsScreenState();
}

class _AdminOutletDetailsScreenState extends State<AdminOutletDetailsScreen> {
  @override
                        ...
                        children: [
                          ...
                          CustomOutlineButton(
                            ...
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => AdminViewFeedbacksScreen(
                                  outletID: widget.outlet["userID"],
                                ),
                              ),
                            ),
                          ),
